// Code goes here
var myApp = angular.module('app',['ui.bootstrap', 'ngGrid', 'ui.bootstrap.datetimepicker','angular-svg-round-progress','myDirectivesApplication']);
...
var resourceTemplate = '<dropdown-multiselect model="selectedResources" options="resourceGridData" resources = "row.getProperty(\'resources\')" index ="row.rowIndex" griddata = "taskGridData" ></dropdown-multiselect>';
...
//Task Grid
 ...
 $scope.tempTaskColumnDefs = [{field: 'name', displayName: 'Name', enableCellEdit: true},
                     ...
                     {field:'resources', displayName:'Resources',cellTemplate: resourceTemplate, enableCellEdit: false}, //, cellFilter: 'resourceFilter'},
